...
### Drift Update — 2026-04-15

Automated drift detection found **1** items. See full report:
`/Users/davidyutzy/Development/aws/drift-reports/huronhelpinghands-2026-04-15.md`
...
### Drift Update — 2026-04-28

Automated drift detection found **2** items. See full report:
`/Users/davidyutzy/Development/aws/drift-reports/huronhelpinghands-2026-04-28.md`
...
| `_domainkey.huronhelpinghands.org.` | TXT | "v=DKIM1; p=" |
| `www.huronhelpinghands.org.` | A | d3rfsda8muk9go.cloudfront.net. |
| :x: | `_domainkey.huronhelpinghands.org.` | **no p= value found in TXT record** |
| `ECK9AA6465NAB` | d3rfsda8muk9go.cloudfront.net | www.huronhelpinghands.org, huronhelpinghands.org | Enabled |
